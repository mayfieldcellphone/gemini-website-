        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-12">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-7xl font-bold mb-4 tracking-tighter leading-none font-display">{brand.name} Restoration</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 -mt-24 relative z-20 pb-32 grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-8 space-y-16">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-[3.5rem] p-10 md:p-16 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.05)] border border-white space-y-10">
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 leading-tight font-display tracking-tight">Precision Intelligence for {brand.name}</h2>
          ...
          <div className="space-y-12">
            <div className="space-y-4">
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 font-display tracking-tight">Supported Catalog</h2>
              <p className="text-slate-500 text-xl font-medium max-w-2xl">Certified hardware restoration available for the following device families.</p>
            </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          <div className="bg-white/60 backdrop-blur-xl rounded-[3rem] border border-white p-10 shadow-2xl shadow-slate-200/50">
            ...
            <ul className="space-y-8">
              {[
                { title: 'Visual Display Sync', desc: 'Shattered glass, digitizer failure, and panel calibration.', icon: Smartphone },
                { title: 'Energy Cell Swap', desc: 'Restore original standby duration and thermal stability.', icon: BatteryCharging },
                { title: 'Liquid Extraction', desc: 'Corrosion prevention and chemical bridge removal.', icon: Droplet },
                { title: 'Power Interface', desc: 'Correction of connectivity variance and port integrity.', icon: Zap },
              ].map((repair, idx) => (
            ...
            <div className="mt-12 pt-10 border-t border-slate-100">
              <div className="flex items-start gap-4 p-6 bg-emerald-50 rounded-[2rem] border border-emerald-100 text-emerald-800">
                ...
                <span className="font-bold text-sm leading-relaxed">Labor and component integrity guaranteed via 90-day warrant protocol.</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 rounded-[3rem] p-12 text-white shadow-2xl relative overflow-hidden group">
             ...
             <h3 className="text-2xl font-bold mb-6 font-display tracking-tight">Component Integrity</h3>
             <p className="text-slate-400 text-lg font-medium leading-relaxed mb-10">
               We reject sub-standard silicon. Every restoration utilizes original spec hardware for maximum longevity.
             </p>
