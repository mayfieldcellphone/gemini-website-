...
export default function RedirectHandler() {
  ...
  useEffect(() => {
    ...
    const redirects: Record<string, string> = {
      ...
      '/google-repair': '/brand/google',
      '/pixel-repair': '/brand/google',
      '/oppo-repair': '/brand/oppo',
      '/motorola-repair': '/brand/motorola',
      '/moto-repair': '/brand/motorola',
      '/huawei-repair': '/brand/huawei',
      '/nokia': '/brand/nokia',
      '/nokia-repair': '/brand/nokia',
      '/xiaomi': '/brand/xiaomi',
      '/xiaomi-repair': '/brand/xiaomi',
      '/redmi-repair': '/brand/xiaomi',
      '/poco-repair': '/brand/xiaomi',
      '/realme': '/brand/realme',
      '/realme-repair': '/brand/realme',
      '/vivo': '/brand/vivo',
      '/vivo-repair': '/brand/vivo',
      '/oneplus': '/brand/oneplus',
      '/oneplus-repair': '/brand/oneplus',
      '/sony': '/brand/sony',
      '/sony-repair': '/brand/sony',
      '/xperia-repair': '/brand/sony',
      '/asus': '/brand/asus',
      '/asus-repair': '/brand/asus',
      '/rog-repair': '/brand/asus',
      '/tcl': '/brand/tcl',
      '/tcl-repair': '/brand/tcl',
      '/nothing': '/brand/nothing',
      '/nothing-repair': '/brand/nothing',
      '/zte': '/brand/zte',
      '/zte-repair': '/brand/zte',
      '/redmagic-repair': '/brand/zte',
