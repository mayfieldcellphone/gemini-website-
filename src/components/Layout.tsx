          ...
          <div className="lg:col-span-7 grid sm:grid-cols-3 gap-12">
             <div className="space-y-8">
               ...
               <ul className="space-y-4 text-sm font-medium">
                 <li><Link to="/second-hand-phones" className="hover:text-blue-400 transition-colors">Buy Refurbished Phones</Link></li>
                 <li><Link to="/accessories" className="hover:text-blue-400 transition-colors">Tech Accessories</Link></li>
                 <li><Link to="/corporate-repairs" className="hover:text-blue-400 transition-colors">Education & B2B Repairs</Link></li>
                 <li><Link to="/after-hours" className="hover:text-emerald-400 transition-colors font-bold">Emergency After Hours</Link></li>
                 <li><Link to="/#services" className="hover:text-blue-400 transition-colors">General Repair Services</Link></li>
               </ul>
             </div>
             <div className="space-y-8">
